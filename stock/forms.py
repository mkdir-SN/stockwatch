...
class TickerForm(forms.ModelForm): 
	...
	def __init__(self, *args, **kwargs): 
		# Override init to access request.user from stock.views
	...
	def clean(self):
		...
		# Make sure time series intraday is accompanied by an interval
	...
	def clean_ticker(self):
		...
		stock = Stock(function='Intraday', symbol=ticker, interval=5) 
